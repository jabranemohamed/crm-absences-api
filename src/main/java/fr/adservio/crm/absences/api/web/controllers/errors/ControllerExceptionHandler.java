...
import static fr.adservio.crm.absences.api.web.controllers.errors.LocationType.requestParameters;
import static fr.adservio.crm.absences.api.web.controllers.errors.LocationType.requestBody;
import static fr.adservio.crm.absences.api.web.controllers.errors.LocationType.requestHeader;
...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleResourceNotFoundException(fr.adservio.crm.absences.api.web.controllers.errors.ResourceNotFound ex, WebRequest request) {
        String errorMessageDescription = ex.getLocalizedMessage();
        errorMessageDescription = errorMessageDescription == null ? ex.toString() : errorMessageDescription;
